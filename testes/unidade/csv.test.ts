...
test('data sai em ISO com o fuso da oficina, não em UTC', () => {
  // Quem abre este arquivo é o dono da oficina, em Cáceres, numa planilha.
  // `12:00Z` para um evento das 08:00 está tecnicamente certo e convida ao
  ...
  expect(csv).toContain('2026-07-30T08:00:00-04:00')
