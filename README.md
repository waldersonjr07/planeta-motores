...
- **Plano em execução:** [`docs/superpowers/plans/2026-07-29-planeta-motores-fundacao-e-cadastros.md`](docs/superpowers/plans/2026-07-29-planeta-motores-fundacao-e-cadastros.md)

## Situação atual

O **Plano 1 — Fundação e Cadastros** está implementado: login, dados da empresa,
clientes, equipamentos e catálogo de serviços, peças e fornecedores.

Ordens de serviço, estoque, compras, financeiro, PDFs, painel e implantação
ficam para os Planos 2 e 3, ainda não escritos. Por isso o menu lateral traz
apenas Clientes, Catálogo e Configurações — menu apontando para tela inexistente
seria defeito, não entrega parcial.

## Stack

Next.js 15 (App Router) · TypeScript · Drizzle ORM · PostgreSQL 17 · Zod ·
Tailwind CSS v4 · Argon2id · Vitest · Playwright
...
```powershell
npm test                  # 94 testes de unidade e integração (Vitest)
npm run teste:e2e         # 15 testes ponta a ponta (Playwright)
```
